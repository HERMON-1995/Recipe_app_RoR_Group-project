...
hermon_recipe_one = Recipe.create(name: "Recipe One", description: "Recipe One Description", user_id: hermon.id)
hermon_recipe_two = Recipe.create(name: "Recipe two", description: "Recipe two Description", user_id: hermon.id)
hermon_recipe_three = Recipe.create(name: "Recipe three", description: "Recipe three Description", user_id: hermon.id)
